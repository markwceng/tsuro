...
public class ClientAnsh {
  ...
  public ClientAnsh(String address, int port) {
    try {
  ...
  public static void main(String args[]) throws IOException {
    ...
    ClientAnsh client1 = new ClientAnsh("localhost", 8000);
